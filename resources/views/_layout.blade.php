            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer-info">
                        <h3>REVE BAR & RESTAURANT</h3>
                        <p>
                            1 Maja 70,<br>
                            58-300 Wałbrzych<br><br>
                            <strong>{{__('Phone')}}:</strong> +48 74 665 54 44<br>
                            <strong>{{__('Email')}}:</strong> H9123@accor.com<br>
                        </p>
...
{{--                </div>--}}
    ...
    <div class="container">
        <div class="copyright">
            &copy; Copyright <strong><span>REVE BAR & RESTAURANT</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
